...
Мы подготовили таблицу с конкурсными работами и их описанием, а так же языком на котором они написаны.
<br>Мы приняли решение не публиковать количество баллов каждой работы, так как работы оценивались в разных номинациях и разным составом жюри.
